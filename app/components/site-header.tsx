  ...
  return (
    <>
      <header className="sticky top-0 z-50 overflow-x-clip border-b border-slate-200/80 bg-white/95 backdrop-blur-xl">
        <div className="relative mx-auto flex h-[82px] max-w-[1340px] items-center justify-between px-5 sm:px-8">
          ...
          <nav className="hidden items-center gap-5 xl:flex" aria-label="Navegação principal">
            ...
            <div className="group/partnerships relative py-7">
              <button type="button" className={`group/navitem relative flex items-center gap-1 text-sm font-bold transition-colors duration-300 hover:text-[#3E1255] ${pathname === "/afiliados" || pathname === "/representante" ? "text-[#3E1255]" : "text-slate-900"}`}>
        ...
        <div className={`bg-white transition-all duration-300 xl:hidden ${menuOpen ? "max-h-[calc(100dvh-82px)] overflow-y-auto border-t border-slate-100 opacity-100" : "max-h-0 overflow-hidden opacity-0"}`}>
