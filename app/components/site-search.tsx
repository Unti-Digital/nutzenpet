...
const pageResults: SearchResult[] = [
  ...
  { id: "page-representative", category: "Páginas", title: "Seja um lojista parceiro", description: "Conheça as vantagens e cadastre sua loja para revender NutzenPet.", href: "/seja-um-lojista-parceiro", keywords: "representante representacao revendedor lojista distribuidor parceria comercial cadastro regioes" },
